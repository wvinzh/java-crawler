...
/** 
 * @ClassName: BerkeleyDBDemo 
 * @Description: BerkeleyDB的demo
 * @author: zengh
 * @date: 2016年10月12日 下午7:16:38  
 */
public class BerkeleyDBDemo {
	...
	public BerkeleyDBDemo(String homeDirectory) {
	...
	public boolean writeToDatabase(String key, String value, boolean isOverwrite) {
		try {  
            ...
            try {  
            	status = database.put(null, theKey, theData);
	...
	public String readFromDatabase(String key) {
		try {
			...
			try {
				...
				// 2、读取数据
				OperationStatus status = database.get(txn, theKey,
